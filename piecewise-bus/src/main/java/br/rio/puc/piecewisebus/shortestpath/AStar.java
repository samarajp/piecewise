...
/**
 * Classe para computar o Algoritmo A*.
 * 
 */

//public class AStar{
//
//	//nó de origem (start); e nó objetivo (goal)
//	public void shortestpath (Vertice start, Vertice goal){
//		//conjunto dos nós que serão descobertos e ainda avaliados
//		
//		System.out.println("Entrou no shortest path");
//		System.out.println("Valor source: "+ start);
//		System.out.println("Valor target: "+ goal);
//
//		List<Vertice> closedSet;
...
//			}
//			current = start;
//			System.out.println("Valor current: "+ current);
//		}
//
//	}
//	
